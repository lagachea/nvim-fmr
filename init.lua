...
vim.keymap.set('n', '<leader>thc',    '<cmd>ToggleTermSendCurrentLine<cr>')
vim.keymap.set('v', '<leader>ths',    '<cmd>ToggleTermSendVisualSelection<cr>')
vim.keymap.set('v', '<leader>thv',    '<cmd>ToggleTermSendVisualLines<cr>')
